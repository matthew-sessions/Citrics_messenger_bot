...
def populationgrowthchart(data):
    ...
    plt.ylabel('Total Population', fontsize=19)
...
def plot_popbreakdown(data):
    ...
    # data to plot
        ...
        plt.ylabel('Total Population by %', fontsize=19)
...
def householdincomeplot(data):
    ...
    # data to plot
        ...
        plt.ylabel('Total numper of households by %', fontsize=19)
...
def capitaincomeplot(data):
    ...
    # data to plot
        ...
        plt.xticks(index + (bar_width / 2), x,fontsize=17)
    ...
    # data to plot
        n_groups = len(list(data[0]['Per Capita by Gender'].values()))
        means_frank = list(data[0]['Per Capita by Gender'].values())
